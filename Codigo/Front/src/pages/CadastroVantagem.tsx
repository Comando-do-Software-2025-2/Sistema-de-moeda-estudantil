  ...
  const infoCards = [
    {
      ...
      description:
        "Ofereça benefícios únicos que motivam os alunos a se destacarem academicamente",
    ...
    },
    {
      ...
      description:
        "Estabeleça valores justos em moedas para cada vantagem cadastrada no sistema",
      icon: <Coins className="h-6 w-6" />,
      gradient: "from-pink-400/25 to-violet-300/8",
    },
    {
      title: "Parcerias Valiosas",
      description:
        "Construa relacionamento com a comunidade estudantil através de benefícios atrativos",
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-12 pt-24">
        ...
        <div className="text-center mb-12 animate-fade-in-up">
          ...
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <p className="text-xl md:text-2xl text-white/95 font-light drop-shadow-md">Cadastro de Vantagem</p>
          </div>
          <p className="text-base text-white/90 max-w-2xl mx-auto drop-shadow-md">
            Registre novas vantagens e benefícios para os alunos resgatarem com suas moedas
          </p>
        </div>
            ...
            <div className="mt-8 pt-8 border-t border-white/20">
              <div className="flex items-center justify-center gap-2 text-white/70 text-sm">
                ...
                <p className="text-center">
                  As vantagens cadastradas ficam disponíveis imediatamente para resgate pelos alunos
                </p>
              </div>
            </div>
          </div>
